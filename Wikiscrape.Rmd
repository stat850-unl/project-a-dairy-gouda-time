...
```{r}
library(XML)
#2020-2018 are on current listing exportable as excel
...
wordcloud(words = wordclouddf$word, freq = df$freq, min.freq = 1,           max.words=200, random.order=FALSE, rot.per=0.25,  scale=c(3.5,0.25),colors=brewer.pal(8, "PuOr")) #purple and orange to be color friendly
```