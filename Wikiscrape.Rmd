...
First of all...the FDA makes getting their data somewhat irritating to me (as in it does not come in comma-seperated values). XML scrape it is!
```{r}
library(XML)
FDAsite = 'http://wayback.archive-it.org/7993/20180125100804/https://www.fda.gov/Safety/Recalls/ArchiveRecalls/2016/default.htm?Page=17'

tbls_xml <- readHTMLTable(FDAsite)
