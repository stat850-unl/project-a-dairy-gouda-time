...
usa70 <- plot_usmap(regions = "states", data = dairy70, values = "milk_produced", color = "black") + 
  scale_fill_continuous(type = "viridis", name = "Production, lb", label = scales::comma, breaks = c(10000000000, 20000000000, 30000000000, 40000000000), limits = c(2500000000, 45000000000)) +
...
usa17 <- plot_usmap(regions = "states", data = dairy70, values = "milk_produced", color = "black") + 
  scale_fill_continuous(type = "viridis", name = "Production, lb", label = scales::comma, breaks = c(10000000000, 20000000000, 30000000000, 40000000000), limits = c(2500000000, 40000000000)) +
  labs(title = "Dairy Production in the United States",
...
animation <- image_animate(image_scale(image, "400x400"), fps = 1, dispose = "previous")
dairygif <- image_write(animation, "usadairy.gif")
