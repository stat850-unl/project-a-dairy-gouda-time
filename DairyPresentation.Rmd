...
This dataset includes 2400 rows with the variables:
...
For example, one entry was listed as Whole Foods, instead of a product category, so I decided to reply on filtering I performed instead. I scraped the names of dairy products listed in an HTML table on wikipedia to filter the dataset. 
